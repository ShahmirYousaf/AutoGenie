...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'New Sunny Motors',
    "address" TEXT NOT NULL DEFAULT '12A Jail Road, Lahore, Pakistan',
    "phone" TEXT NOT NULL DEFAULT '+0 (42) 123-4567',
    "email" TEXT NOT NULL DEFAULT 'newsunnymotors@gmail.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

...
const CarCard = ({ car }) => {
    ...
    useEffect(() => {
        console.log("Toggle Error: ", toggleError);
        if (toggleError) {
    ...
    const handleToggleSave = async (e) => {
        ...
        console.log("Toggling save for car ID: ", car.id);
                ...
                {car.images && car.images.length > 0 ? (
                    <div className='relative h-full w-full'>
                        ...
                        <Image
                            ...
                            fill="true"
                            className='object-cover group-hover:scale-105 transition duration-300 w-full h-40 object-cover rounded'
                        />
                    </div>
                ) : (
                    <div>
